 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="" data-target="#collapseBootstrap"
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="" data-target="#collapseBootstrapusers"
          aria-expanded="true" aria-controls="collapseBootstrapusers">
          <i class="fas fa-code-branch"></i>
          <a href="createClassArms.php">Create Class Delegate</a>
        </a>
      </li>
       <hr class="sidebar-divider">
      <div class="sidebar-heading">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="" data-target="#collapseBootstrapassests"
      ...
      <div class="sidebar-heading">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="" data-target="#collapseBootstrap2"
      ...
      <div class="sidebar-heading">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="" data-target="#collapseBootstrapcon"
